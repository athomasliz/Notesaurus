...
#### Input (Verify)
  ...
  - Payload
#### Output (Verify)
  - Calculated Signature = Received Signature from him
```mdx-code-block
</TabItem>
</Tabs>
```
...
- `VRF` [Verifiable random function](https://en.wikipedia.org/wiki/Verifiable_random_function)
  - Steps for generation
    - Input
      ...
      - Prepare a seed
    - Ouptput
      - Signature - use my private key to sign the seed to get (Sign)
      - Random number - hash the seed (MAC)
  - Verification
