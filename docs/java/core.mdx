...
1. Shortcut for running single file source code.
    ...
    - This feature is designed for situation when your program is in one single file, such as testing.
### Package and Import
...
1. Naming conflicts
    ...
    - The same class name may therefore be found in multiple places under different packages.
...
1. There are 8 <Term>Primitive</Term> types.
...
1. You <Warn>cannot</Warn> put underscore at the beginning or end of a literal, or right before or after a decimal point.
    ...
    ```
### Reference Type
1. A <Term>reference</Term> type refers to an object.
...
1. For `final` variable of primitive type, you <Warn>cannot</Warn> change its value once it is initiailized.
